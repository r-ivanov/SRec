...
public class CuadroParam extends Thread implements ActionListener, KeyListener, MouseListener
{
	...
	*/
	public CuadroParam(MetodoAlgoritmo metodo, ClaseAlgoritmo clase, CuadroMetodosProcesados cmp, boolean editarValores, int numMetodo)
	{	
		dialogo = new JDialog(cmp.getDialogo()/*VentanaVisualizador.thisventana*/,true);
		...
		this.clase=clase;
		this.cmp=cmp;
		this.editarValores=editarValores;
