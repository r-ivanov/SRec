...
public class GestorVentanaSRec implements WindowListener, WindowStateListener
{
	...
	/**
		Añade los menús neesarios a la barra de menú de la ventana del visualizador.
		
		@param barramenu Recibe la barra de menús del visualizador
	*/
	private static void anadirMenus(JMenuBar barramenu, JMenu menus[])
	{
		...
		// Menú Archivo
		String noArchivo[]={
							Texto.get("MENU_ARCH_00",Conf.idioma),
							...
							//Texto.get("MENU_ARCH_05",Conf.idioma),
		...
		String iconosArchivo[]={//"./imagenes/icono_abrircodigo.gif",
								//"./imagenes/icono_abrircodigoclase.gif", 
								"./imagenes/i_nuevaclase.gif",
								"./imagenes/i_guardarclase.gif",
								"./imagenes/i_abrirclase.gif",
								"./imagenes/i_compilarclase.gif",
								"./imagenes/i_seleccionmetodo.gif",
								"./imagenes/i_nuevavisualizacion.gif",
								//"./imagenes/i_vacio.gif",
								...
								"./imagenes/i_exportartraza.gif",
								"./imagenes/i_cerrar.gif"};
		int sepArchivo[]={3,8,11}; // Separador debajo de las cuarta, séptima y décima opción de menú (contamos desde cero)
		KeyStroke ksArchivo[]={ //KeyStroke.getKeyStroke(java.awt.event.KeyEvent.VK_A,java.awt.Event.CTRL_MASK),
						KeyStroke.getKeyStroke(java.awt.event.KeyEvent.VK_E,java.awt.Event.CTRL_MASK),
						KeyStroke.getKeyStroke(java.awt.event.KeyEvent.VK_E,java.awt.Event.CTRL_MASK),
						KeyStroke.getKeyStroke(java.awt.event.KeyEvent.VK_P,java.awt.Event.CTRL_MASK),
						KeyStroke.getKeyStroke(java.awt.event.KeyEvent.VK_R,java.awt.Event.CTRL_MASK),
						KeyStroke.getKeyStroke(java.awt.event.KeyEvent.VK_M,java.awt.Event.CTRL_MASK),
						...
						KeyStroke.getKeyStroke(java.awt.event.KeyEvent.VK_I,java.awt.Event.CTRL_MASK),
						KeyStroke.getKeyStroke(java.awt.event.KeyEvent.VK_G,java.awt.Event.CTRL_MASK),
						null,
						null,
						null,
						KeyStroke.getKeyStroke(java.awt.event.KeyEvent.VK_T,java.awt.Event.CTRL_MASK),
						KeyStroke.getKeyStroke(java.awt.event.KeyEvent.VK_X,java.awt.Event.CTRL_MASK)};
		menus[0]=creaMenu(noArchivo,mnArchivo,iconosArchivo,nombreMenuArchivo,mnMenuArchivo,sepArchivo,ksArchivo);
		
		//habilitaMenuItem(menuFichero, Texto.get("MENU_ARCH_02",Conf.idioma), false);
		habilitaMenuItem(menus[0], Texto.get("MENU_ARCH_04",Conf.idioma), false);
		habilitaMenuItem(menus[0], Texto.get("MENU_ARCH_14",Conf.idioma), false);
		habilitaMenuItem(menus[0], Texto.get("MENU_ARCH_15",Conf.idioma), false);
		//habilitaMenuItem(menus[0], Texto.get("MENU_ARCH_05",Conf.idioma), false);
		habilitaMenuItem(menus[0], Texto.get("MENU_ARCH_07",Conf.idioma), false);
		habilitaMenuItem(menus[0], Texto.get("MENU_ARCH_09",Conf.idioma), false);
		habilitaMenuItem(menus[0], Texto.get("MENU_ARCH_10",Conf.idioma), false);
		habilitaMenuItem(menus[0], Texto.get("MENU_ARCH_11",Conf.idioma), false);
		habilitaMenuItem(menus[0], Texto.get("MENU_ARCH_12",Conf.idioma), false);
		...
		String iconosAnimacion[]={
										"./imagenes/i_idMetodo_des.gif",
										"./imagenes/i_estadoInicial.gif",
										"./imagenes/i_formato.gif",
										"./imagenes/i_zoom.gif",
										"./imagenes/i_ubicacionpaneles.gif"
										};
		int sepAnimacion[]={};	// Separador debajo de la primera opción de menú (contamos desde cero)
		...
		menus[1]=creaMenu(noAnimacion,mnAnimacion,iconosAnimacion,nombreMenuAnimacion,
									mnMenuAnimacion,sepAnimacion,ksAnimacion);
		
		habilitaMenuItem(menus[1], Texto.get("MENU_VISU_11",Conf.idioma), false);
		habilitaMenuItem(menus[1], Texto.get("MENU_VISU_12",Conf.idioma), false);
		...
		int sepFiltrado[]={3};	// Separador debajo de la primera opción de menú (contamos desde cero)
		KeyStroke ksFiltrado[]={ 	
									null,
									null,
									null,
									null,
		...
		menus[5]=creaMenu(noFiltrado,mnFiltrado,iconosFiltrado,nombreMenuFiltrado,
									mnMenuFiltrado,sepFiltrado,ksFiltrado);
		
		
		habilitaMenuItem(menus[5], Texto.get("MENU_FILT_01",Conf.idioma).replace("_SubMenuItem_","").replace("_CheckBoxMenuItem_",""), false);
		habilitaMenuItem(menus[5], Texto.get("MENU_FILT_04",Conf.idioma), false);
		habilitaMenuItem(menus[5], Texto.get("MENU_FILT_05",Conf.idioma), false);
		...
		int sepArbol[]={};	// Separador debajo de la primera opción de menú (contamos desde cero)
		KeyStroke ksArbol[]={ 	
									null,
									null,
									null,
		...
		int sepTraza[]={};	// Separador debajo de la primera opción de menú (contamos desde cero)
		KeyStroke ksTraza[]={ 	
									null,
									null,
									null,
		...
		// Menú Información
		String noInformacion[]={	Texto.get("MENU_INFO_01",Conf.idioma),		//	Info animación
		...
		char mnMenuInformacion=mnemotecnicos.charAt(mnemotecnicos.length()-1);
		String iconosInformacion[]={	"./imagenes/i_infovisualizacion.gif",
										"./imagenes/i_infonodo.gif",
										};
		int sepInformacion[]={};	// Separador debajo de la primera opción de menú (contamos desde cero)
		KeyStroke ksInformacion[]={ 
						null,
						null,
						};
		menus[2]=creaMenu(noInformacion,mnInformacion,iconosInformacion,nombreMenuInformacion,
									mnMenuInformacion,sepInformacion,ksInformacion);
		//activaCheck(menuInformacion,Texto.get("MENU_VISU_07",Conf.idioma).replace("_CheckBoxMenuItem_",""));
		
		habilitaMenuItem(menus[2], Texto.get("MENU_INFO_01",Conf.idioma), false);
		habilitaMenuItem(menus[2], Texto.get("MENU_INFO_02",Conf.idioma), false);
		
		
		// Menú Configuración
		String noConfiguracion[]={	
									Texto.get("MENU_VISU_13",Conf.idioma),
									...
									Texto.get("MENU_CONF_01",Conf.idioma),		//	Cuadro archivos intermedios
									Texto.get("MENU_CONF_02",Conf.idioma),		//	Cuadro MV Java
									Texto.get("MENU_CONF_03",Conf.idioma),		//	Cuadro idioma
									Texto.get("MENU_CONF_04",Conf.idioma),		//	Opción toggle ver barra herramientas
									 };	
		...
		char mnMenuConfiguracion=mnemotecnicos.charAt(mnemotecnicos.length()-1);
		String iconosConfiguracion[]={	"./imagenes/i_vacio.gif",
										...
										"./imagenes/i_mvjava.gif",
										"./imagenes/i_idioma.gif",
										"./imagenes/i_verbarrahh.gif",
										};
		int sepConfiguracion[]={3,6};	// Separador debajo de la primera opción de menú (contamos desde cero)
		KeyStroke ksConfiguracion[]={ 
						...
						null,
						KeyStroke.getKeyStroke(java.awt.event.KeyEvent.VK_I,java.awt.Event.CTRL_MASK),
						KeyStroke.getKeyStroke(java.awt.event.KeyEvent.VK_J,java.awt.Event.CTRL_MASK),
		...
		menus[3]=creaMenu(noConfiguracion,mnConfiguracion,iconosConfiguracion,nombreMenuConfiguracion,
									mnMenuConfiguracion,sepConfiguracion,ksConfiguracion);
		
		
		
		
		habilitaMenuItem(menus[3], Texto.get("MENU_VISU_03",Conf.idioma), false);
		habilitaMenuItem(menus[3], Texto.get("MENU_VISU_12",Conf.idioma), false);
		...
		// Menú Ayuda
		String noAyuda[]={Texto.get("MENU_AYUD_01",Conf.idioma), Texto.get("MENU_AYUD_02",Conf.idioma)};
		...
		String iconosAyuda[]={"./imagenes/i_srecayuda.gif", "./imagenes/i_srec.gif"};
		KeyStroke ksAyuda[]={ KeyStroke.getKeyStroke(java.awt.event.KeyEvent.VK_F1,0),
						KeyStroke.getKeyStroke(java.awt.event.KeyEvent.VK_S,java.awt.Event.CTRL_MASK)};
		menus[4]=creaMenu(noAyuda,mnAyuda,iconosAyuda,nombreMenuAyuda,mnMenuAyuda,null,ksAyuda);		
		
		
		activaChecks(menus);
		
		// Adición de menús. El orden ha cambiado. No podemos utilizar el bucle.
		/*
		for (int i=0; i<menus.length; i++)
	...
	/**
		Crea un menú, que será añadido a la barra de menús de la ventana de la aplicación.
		
		@param nombreOpciones Listado con los textos que aparecerán en el menú para cada opción.
		@param mnemotecOpciones Listado de letras que servirán de mnemotécnicos para cada opción.
		@param nombreMenu Nombre del menú que se va a generar, será lo que aparezca en la barra de menús.
		@param mnemotecMenu Letra que servirá de mnemotécnico al menú.
		@param separadores Array con el número de posiciones donde deben ir colocados los separadores entre las opciones.
	*/
	private static JMenu creaMenu(String nombreOpciones[], char mnemotecOpciones[], String iconos[], 
				String nombreMenu, char mnemotecMenu, int separadores[], KeyStroke ks[])
	{
		JMenuItem items[]=new JMenuItem[nombreOpciones.length];
		//System.out.println("VentanaVisualizador creacion Menu "+nombreMenu+" ("+nombreOpciones.length+")");
		...
		while(indice_opciones<longitud)
		{
			...
			if (nombreOpciones[indice_opciones].contains("_CheckBoxMenuItem_") &&
				!nombreOpciones[indice_opciones].contains("_SubMenuItem_"))
			{
				items[i]=new JCheckBoxMenuItem(nombreOpciones[indice_opciones].replace("_CheckBoxMenuItem_",""));
				items[i].setMnemonic( new Character(mnemotecOpciones[indice_opciones]) );
				if (iconos[i]!=null)
			...
			{
				items[i]=new JMenu(nombreOpciones[indice_opciones].replace("_SubMenu_",""));
				items[i].setMnemonic( new Character(mnemotecOpciones[indice_opciones]) );
				ultimoSubmenu=i;
				if (iconos[i]!=null)
					items[i].setIcon( new ImageIcon(iconos[i]) );
			...
			else if (nombreOpciones[indice_opciones].contains("_SubMenuItem_"))
			{
				if (!nombreOpciones[indice_opciones].contains("_CheckBoxMenuItem_"))
				{
					JMenuItem smi=new JMenuItem(nombreOpciones[indice_opciones].replace("_SubMenuItem_",""));
					if (iconos[i]!=null)
				...
				{
					JMenuItem smi=new JCheckBoxMenuItem(nombreOpciones[indice_opciones].replace("_SubMenuItem_","").replace("_CheckBoxMenuItem_",""));
					if (iconos[i]!=null)
						smi.setIcon( new ImageIcon(iconos[i]) );
					smi.addActionListener(Ventana.thisventana);
					if (ks!=null && ks[i]!=null)
			...
			{
				items[i]=new JMenuItem(nombreOpciones[indice_opciones],new Character(mnemotecOpciones[indice_opciones]));
				if (iconos[i]!=null)
					items[i].setIcon( new ImageIcon(iconos[i]) );
				items[i].addActionListener(Ventana.thisventana);
				if (ks!=null && ks[i]!=null)
		...
		for (i=0; i<items.length; i++)
		{
			if (items[i]!=null)
				menu.add(items[i]);
			if ( (separadores!=null && contains(separadores,i)) || separadorlista==i)
				menu.addSeparator();
		}

		}
		catch (Exception e) {
			System.out.println("GestorVentanaSRec creaMenu ha ocasionado un problema");
			e.printStackTrace();
		}
		return menu;
	}
	...
	private static boolean[][] getEstadoVisibilidadMenu(JMenuBar barramenu)
	{
		if (barramenu!=null)
		{
			boolean [][]estado=new boolean[barramenu.getMenuCount()][];	// Hay 3 menús
	...
	private static void setEstadoVisibilidadMenu(JMenuBar barramenu,boolean[][] estado)
	{
		try {
	...
	public static void activaChecks (JMenu[] menus)
	{
		...
		activaCheck(menus[1],Texto.get("MENU_VISU_05",Conf.idioma).replace("_SubMenuItem_","").replace("_CheckBoxMenuItem_",""),
				oov.getMostrarArbolSalto());
		activaCheck(menus[5],Texto.get("MENU_FILT_03",Conf.idioma).replace("_SubMenuItem_","").replace("_CheckBoxMenuItem_",""),
				oov.getMostrarArbolSalto());
		activaCheck(menus[1],Texto.get("MENU_VISU_06",Conf.idioma).replace("_SubMenuItem_","").replace("_CheckBoxMenuItem_",""),
				oov.getMostrarVisor());
		activaCheck(menus[6],Texto.get("MENU_ARBL_01",Conf.idioma).replace("_SubMenuItem_","").replace("_CheckBoxMenuItem_",""),
				oov.getMostrarVisor());
		activaCheck(menus[1],Texto.get("MENU_VISU_07",Conf.idioma).replace("_SubMenuItem_","").replace("_CheckBoxMenuItem_",""),
				oov.getMostrarEstructuraEnArbol());
		activaCheck(menus[6],Texto.get("MENU_ARBL_02",Conf.idioma).replace("_SubMenuItem_","").replace("_CheckBoxMenuItem_",""),
				oov.getMostrarEstructuraEnArbol());
		activaCheck(menus[6],Texto.get("MENU_ARBL_03",Conf.idioma).replace("_SubMenuItem_","").replace("_CheckBoxMenuItem_",""),
				oov.getAjustarVistaGlobal());
		activaCheck(menus[6],Texto.get("MENU_ARBL_04",Conf.idioma).replace("_SubMenuItem_","").replace("_CheckBoxMenuItem_",""),
				oov.getVisualizacionDinamica());
		activaCheck(menus[1],Texto.get("MENU_VISU_08",Conf.idioma).replace("_SubMenuItem_","").replace("_CheckBoxMenuItem_",""),
				oov.getMostrarEstructuraCompletaCrono());
		
		activaCheck(menus[1],Texto.get("MENU_VISU_09",Conf.idioma).replace("_SubMenuItem_","").replace("_CheckBoxMenuItem_",""),
				oov.getMostrarSalidaLigadaEntrada());
		
		activaCheck(menus[1],Texto.get("MENU_VISU_17",Conf.idioma).replace("_SubMenuItem_","").replace("_CheckBoxMenuItem_",""),
				oov.getMostrarArbolColapsado());
		activaCheck(menus[1],Texto.get("MENU_VISU_18",Conf.idioma).replace("_SubMenuItem_","").replace("_CheckBoxMenuItem_",""),
				oov.getArranqueEstadoInicial());
		activaCheck(menus[6],Texto.get("MENU_ARBL_00",Conf.idioma).replace("_SubMenuItem_","").replace("_CheckBoxMenuItem_",""),
				oov.getMostrarArbolColapsado());
		
		activaCheck(menus[7],Texto.get("MENU_TRAZ_00",Conf.idioma).replace("_SubMenuItem_","").replace("_CheckBoxMenuItem_",""),
				oov.getSangrado());
		
		activaCheck(menus[1],Texto.get("MENU_VISU_19",Conf.idioma).replace("_SubMenuItem_","").replace("_CheckBoxMenuItem_",""),
				oov.getIdMetodoTraza());
		
		activaCheck(menus[7],Texto.get("MENU_TRAZ_02",Conf.idioma).replace("_SubMenuItem_","").replace("_CheckBoxMenuItem_",""),
				!oov.getMostrarSalidaLigadaEntrada());
		
		activaCheck(menus[7],Texto.get("MENU_TRAZ_03",Conf.idioma).replace("_SubMenuItem_","").replace("_CheckBoxMenuItem_",""),
				oov.getSoloEstructuraDYVcrono());
	
		activaCheck(menus[7],Texto.get("MENU_TRAZ_04",Conf.idioma).replace("_SubMenuItem_","").replace("_CheckBoxMenuItem_",""),
				oov.getMostrarEstructuraCompletaCrono());
		...
		obf=(OpcionBorradoFicheros)gOpciones.getOpcion("OpcionBorradoFicheros",false);
		
		activaCheck(menus[3],Texto.get("MENU_CONF_04",Conf.idioma).replace("_CheckBoxMenuItem_",""),true);
		activaCheck(menus[3],Texto.get("MENU_CONF_05",Conf.idioma).replace("_SubMenuItem_","").replace("_CheckBoxMenuItem_",""),
				obf.getLOG());
	}
	...
	private static void activaCheck (JMenu menu, String nombreElemento, boolean valor)
	{
		...
		for (int i=0; i<items.length; i++)
			if (items[i] instanceof JCheckBoxMenuItem && ((JCheckBoxMenuItem)items[i]).getText().equals(nombreElemento))
	...
	protected static void habilitaMenuItem(JMenu menu, String nombreElemento, boolean valor)
	{
		//System.out.println("GestorVentana SRec > habilitaMenuItem: intentamos poner "+valor+" a "+nombreElemento);
		JMenuItem items[]=new JMenuItem[menu.getItemCount()];
		...
		for (int i=0; i<items.length; i++)
		{
			...
			{
				//System.out.println("GestorVentana SRec > habilitaMenuItem: ponemos "+valor+" a "+nombreElemento);
				items[i].setEnabled(valor);
			}
			else if (items[i]!=null && items[i] instanceof JMenu)
			{
				//System.out.println("GestorVentana SRec > habilitaMenuItem: encontramos submenu "+items[i].getText());
				habilitaMenuItem((JMenu)items[i],nombreElemento,valor);
			}
		}
	}
	
	protected static void iconoMenuItem(JMenu menu, String nombreElemento, String path)
	{
		//System.out.println("GestorVentana SRec > habilitaMenuItem: intentamos poner "+valor+" a "+nombreElemento);
		JMenuItem items[]=new JMenuItem[menu.getItemCount()];
	...
	protected static JToolBar[] creaBarrasHeramientas(JButton[] botones)
	{
		...
		botones[ 3]=new JButton( new ImageIcon("./imagenes/i_compilarclase.gif") );
		...
		botones[ 6]=new JButton( new ImageIcon("./imagenes/i_guardarvisualizacion.gif") );
		
		// Grupo exportación
		botones[ 7]=new JButton( new ImageIcon("./imagenes/i_exportaranimacion.gif") );
		botones[ 9]=new JButton( new ImageIcon("./imagenes/i_exportarestado.gif") );
		// antiguos
		botones[ 8]=new JButton( new ImageIcon("./imagenes/i_exportarestados.gif") );

		// Grupo opciones 1
		botones[10]=new JButton( new ImageIcon("./imagenes/i_entradasalida.gif") );
		botones[11]=new JButton( new ImageIcon("./imagenes/i_vermetodosparam.gif") );
		botones[30]=new JButton( new ImageIcon("./imagenes/i_llamadasmarcar.gif") );
		botones[31]=new JButton( new ImageIcon("./imagenes/i_llamadasdesmarcar.gif") );
		// antiguos
		botones[12]=new JButton( new ImageIcon("./imagenes/i_nodoshistoricos.gif") );
		botones[13]=new JButton( new ImageIcon("./imagenes/i_mostrarsubarbol.gif") );
		botones[14]=new JButton( new ImageIcon("./imagenes/i_mostrarvisor.gif") );
		botones[32]=new JButton( new ImageIcon("./imagenes/i_ligarescrono.gif") );
		botones[33]=new JButton( new ImageIcon("./imagenes/i_estructuraarbol.gif") );
		botones[34]=new JButton( new ImageIcon("./imagenes/i_infovisualizacion.gif") );
		
		// Grupo opciones 2
		// antiguos
		botones[15]=new JButton( new ImageIcon("./imagenes/i_estructuraarbol.gif") );
		botones[16]=new JButton( new ImageIcon("./imagenes/i_estructcompletacrono.gif") );
		botones[17]=new JButton( new ImageIcon("./imagenes/i_ligarescrono.gif") );
		botones[18]=new JButton( new ImageIcon("./imagenes/i_arbolcolapsado.gif") );
		...
		// antiguos
		botones[27]=new JButton( new ImageIcon("./imagenes/i_ubicacionpaneles.gif") );	
		
		//botones[21]=new JButton( new ImageIcon("./imagenes/icono_ayuda.gif") );	
		...
		// Creamos las barras de herramientas donde insertaremos los botones creados
		...
		for (int i=0; i<barras.length; i++)
		{
			...
			//barras[i].setBorder(new  BorderUIResource.BevelBorderUIResource(BevelBorder.LOWERED));	// biselado blanco y negro (RAISED/LOWERED)
			//barras[i].setBorder(new  BorderUIResource.CompoundBorderUIResource());				// Sin probar
			//barras[i].setBorder(new  BorderUIResource.EtchedBorderUIResource());					// Línea gris simple
			//barras[i].setBorder(new  BorderUIResource.LineBorderUIResource(new Color(255,0,0),4));	// línea configurable (color,grosor)
			//barras[i].setBorder(new  BorderUIResource.MatteBorderUIResource(1, 1, 2, 2, new Color(130,130,130)));	// líneas de grosor configurable
			//barras[i].setBorder(new  BorderUIResource.MatteBorderUIResource(3, 3, 3, 3, new ImageIcon("./imagenes/magonorton.jpg")));	// líneas de grosor configurable

			barras[i].setBorder(new  MetalBorders.PaletteBorder());	// Borde parecido a bordes de cuadros de diálogo, redondeado
			//barras[i].setBorder(new  MetalBorders.ToolBarBorder());		// línea blanca inferior
			//barras[i].setBorder(new  TitledBorder(""));	// Borde gris, como el de los bordes de los diálogos
		}
		...
		for (int i=0; i<4; i++)		// Grupo de carga y edición de clases
		...
		for (int i=10; i<12; i++)	// Grupo de opciones 1
			barras[3].add(botones[i]);
		barras[3].add(botones[30]);
		barras[3].add(botones[31]);
	
		barras[4].add(botones[14]);	// Grupo de opciones 2
		barras[4].add(botones[33]);
		barras[4].add(botones[32]);
		barras[4].add(botones[34]);

		for (int i=19; i<27; i++)	// Grupo de opciones de formato
			barras[5].add(botones[i]);
		
	
		//for (int i=21; i<22; i++)	// Grupo de ayuda
		//	barras[4].add(botones[i]);
	...
	protected static void setToolTipTextBHH(JButton[] botones)
	{
		...
		// Ayuda
		//botones[21].setToolTipText(Texto.get("BARRA_HERR_TTT16",Conf.idioma));
	}
	
	protected static void setVisibleBarraHerramientas(JToolBar[] barrasHerramientas, boolean valor, boolean actualizarEstado)
	{
		for (int i=0; i<barrasHerramientas.length; i++)
		{
			barrasHerramientas[i].setVisible( valor );
			if (i==0 && actualizarEstado)
				Ventana.thisventana.barraHerramientasVisible=barrasHerramientas[i].isVisible();
		}
	}
	...
	/**
		Método auxiliar que revisa si en un array de enteros se encuentra un determinado número.
		
		@param x Array de números enteros
		@param y Número entero que se desea buscar
