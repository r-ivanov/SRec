...
/**
 * Genera números aleatorios cuyo valor absoluto es menor o igual que un valor
 * limite dado. Puede generar sólo valores positivos
 * 
...
public class ValorAleatorio {
	...
	/**
	 * Devuelve un número aleatorio entre 0 y el máximo especificado.
	 * 
	 * @param x
	 *            Limite superior del valor.
	 * 
	 * @return Número aleatorio entre 0 y x.
	 */
	...
	/**
	 * Devuelve un número de tipo long aleatorio.
	 * 
	 * @return Número de tipo long aleatorio.
	 */
	...
	/**
	 * Devuelve un número de tipo float aleatorio.
	 * 
	 * @return Número de tipo float aleatorio.
	 */
	...
	/**
	 * Devuelve un número de tipo double aleatorio.
	 * 
	 * @return Número de tipo double aleatorio.
	 */
	...
	/**
	 * Dado un número entero, devuelve un carácter.
	 * 
	 * @param x
	 *            Número entero.
	 * 
	...
	/**
	 * Genera un valor aleatorio entero entre un mínimo y máximo especificados.
	 * 
	 * @param min
	 *            Valor mínimo.
	 * @param max
	 *            Valor máximo.
	 * 
	 * @return Valor aleatorio entre el mínimo y el máximo.
	 */
	...
	/**
	 * Genera un valor aleatorio short entre un mínimo y máximo especificados.
	 * 
	 * @param min
	 *            Valor mínimo.
	 * @param max
	...
	/**
	 * Genera un valor aleatorio byte entre un mínimo y máximo especificados.
	 * 
	 * @param min
	 *            Valor mínimo.
	 * @param max
	...
	/**
	 * Genera un valor aleatorio long entre un mínimo y máximo especificados.
	 * 
	 * @param min
	 *            Valor mínimo.
	 * @param max
	...
	/**
	 * Genera un valor aleatorio double entre un mínimo y máximo especificados.
	 * 
	 * @param min
	 *            Valor mínimo.
	 * @param max
	...
	/**
	 * Trunca un valor double eliminando la representación exponencial de
	 * decimales.
	 * 
	 * @param x
	 *            valor double.
	...
	/**
	 * Genera un String aleatorio de tamaño entre 3 y 10.
	 * 
	 * @return String aleatorio
	 */
