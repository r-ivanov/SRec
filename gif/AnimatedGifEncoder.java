...
kweiner@fmsware.com. * * @author Kevin Weiner, FM Software * @version 1.03 
November 2003 * */ 
...
public class AnimatedGifEncoder
{
	...
	* @param ms int delay time in milliseconds */ 
	...
	color has been set, otherwise 2. * @param code int disposal code. */
	...
	* @param iter int number of iterations. * @return */
	...
	* closed. */ 
	public boolean finish()
	{
		...
		started = false;
		try {
			out.write(0x3b); // gif trailer out.flush(); 
			if (closeStream)
			{
				out.close();
			}
	...
	* @return false if open or initial write failed. */
	...
	protected void analyzePixels()
	{
		...
		colorTab = nq.process(); // create reduced palette // convert map from BGR to RGB 
