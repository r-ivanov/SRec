...
public class CargadorTraza extends Thread
{
	...
	*/
		...
		if (fichero!=null && fichero[1]!=null)
		{
			...
			if (fichero[1]!=null)
			{
				...
				try {
					// Ahora toca:
					//  - 01 Cargar Document
					//  - 02 Extraer datos de configuración y guardar opciones
					//  - 03 Actualizar clase Conf
					//  - 04 Crear traza nueva
					//  - 05 Extraer título del panel
					//  - 06 abrir nuevo panel de visualización con la traza y el título a través de VentanaVisualizador
					...
					else
					{
						...
						if (Conf.fichero_log)	Logger.log_write("Animación cargada: "+dtb.getArchivo()+" (método "+dtb.getNombreMetodoEjecucion()+")");
	...
	/**
		...
		@param e Element del que se extraerán los datos
	...
	*/
	...
	/**
		...
		@param e Element del que se extraerán los datos para la traza
	...
	*/
	...
	/**
		...
		@param ra Registro de activación actual (el método es recursivo)
		@param e Element del que se extraerán los datos
		@param traza en la cual se irán agregando los registros de activación en función de los valores leídos
	*/
